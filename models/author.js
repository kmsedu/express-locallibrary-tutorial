...
AuthorSchema.virtual("lifespan").get(function() {
  ...
  if (this.date_of_birth) {
    dateOfBirth = DateTime.fromJSDate(this.date_of_birth).toLocaleString(DateTime.DATE_MED);
  }

  if(this.date_of_death) {
    dateOfDeath = DateTime.fromJSDate(this.date_of_death).toLocaleString(DateTime.DATE_MED);
  }
